### picturekeys python3 string hiding ###
'''
    in chat client:
    import picturekeys
    a = picturekeys.Materials() | default arg : pictureFileName='hubble.png'
    a.encrypt('TEXT')           | delivers a keyed string
    a.decrypt(keyedstring)      | delivers back the text
    a.changekey(index)          | changes the key per index
...
class Materials:
    def __init__(self, pictureFileName='materials/hubble.png'):
        ...
        if pictureFileName:
            ...
            # fill KEYDATA with 1028 byte-blocks
